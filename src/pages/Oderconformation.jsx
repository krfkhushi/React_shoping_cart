...
const Oderconformation = ({ deliveryDetails }) => {
  return (
    <>
      <div className='container mx-auto md:px-8 pt-12'>
        <div className='p-12 bg-gray-900 rounded-3xl shadow-2xl max-w-2xl mx-auto text-center mt-12 border border-gray-700 text-white'>
          <CheckCircle className="w-22 h-22 text-green-500 mx-auto mb-6 drop-shadow-lg " />
          ...
          <Link to={'/'} className="mt-10 px-4 py-4 bg-orange-600 font-extrabold text-white rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider">
            Continue Shopping
          </Link>
        </div>
      </div>
...
export default Oderconformation
